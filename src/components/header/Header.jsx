  ...
  return (
    <header className="header">
        <nav className="nav container">
            <a href="index.html" className="nav__logo">Awasthi</a>
                ...
                <ul className="nav__list grid">
                    ...
                    <li className="nav__item">
                        <a href="#contact" className="nav__link">
                            <i className="uil uil-comment-alt-exclamation nav__icon"></i> Contact
                        </a>
                    </li>
                </ul>

                <i 
                className="uil uil-times-circle nav__close" onClick={() => showMenu(!Toggle)}
                ></i>
            </div>
